		...
		if (inputStream != null)
		{
			...
			try {
				...
				if (properties.containsKey("IMPLEMENTATION_VERSION"))
					...
					System.out.print(s_ImplementationVersion);
...
//				DB.getSQLValueString(null, "select lastmigrationscriptapplied from ad_system"));
		...
		String databaseVersion = MSysConfig.getValue(MSysConfig.APPLICATION_DATABASE_VERSION,
				DB.getSQLValueString(null, "select lastmigrationscriptapplied from ad_system"));
		
		System.out.print(databaseVersion);
